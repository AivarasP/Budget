...
function EditExpense() {
  ...
  return (
    <div className='w-screen h-full flex flex-col justify-center items-center mt-16'>
            <h1 className='text-black text-3xl font-semibold font-Montserrat'>Redaguoti Išlaidas</h1>
            <form className='w-[80%] h-full flex flex-col justify-center items-center mt-4'>
                ...
                <input value={comment} onChange={(e) => SetComment(e.target.value)} type="text" required placeholder='Išlaidos' className='w-[80%] bg-white/10 mt-4 text-xl font-Montserrat font-normal outline-none py-4 pl-6 border border-zinc-400' />
